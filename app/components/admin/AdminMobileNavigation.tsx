...
export default function AdminMobileNavigation({ show, onClose }: { show: boolean, onClose: () => void }) {
    ...
    return (<div data-show={show} ref={mobileNav}
        className='mobileNav flex flex-col fixed top-0 z-10 data-[show=true]:animate-slide-in-left data-[show=false]:left-full data-[show=false]:animate-slide-out- bg-secondary w-full h-dvh overflow-y-auto'>
