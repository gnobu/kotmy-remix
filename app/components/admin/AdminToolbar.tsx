...
export default function AdminToolbar() {
    ...
    return (
        <div className="relative">
            <div onClick={() => { setOpen(prev => !prev) }} onBlur={() => { setOpen(false) }} tabIndex={1}
                className='p-2 rounded-full border border-primary flex items-center gap-4 cursor-pointer hover:bg-[#EEF0FF]'>
            ...
            {open
                ? <ul className='absolute top-[105%] bg-tertiary w-full p-2 rounded-2xl border border-primary text-xs'>
