...
export default function ContestTableActions({ rowData }: { rowData: Contest }) {
    return (
        <div className="flex gap-4 items-center">
            ...
            <RoundCta icon={icons.editIcon} element="link" to={'.'} className="border-[#262626] bg-[#F7F7F8] text-primary" />
            <RoundCta icon={icons.viewIcon} element="link" to={'.'} className="border-yellow-700 bg-yellow-100 text-yellow-700" />
